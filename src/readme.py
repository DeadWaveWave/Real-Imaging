...
## 如何使用？
进入 Real-Imaging/src，首次运行需要执行 init.py 程序或启动应用后在“应用介绍”页面底部点击按钮以初始化图库。运行 app.py 程序或通过 app.ipynb 执行代码，使用浏览器输入 127.0.0.1:7860 进入述图页面进行图库搜索。在左上角点击“图片上传”可进行上传图片或图片集的压缩文件（zip）到图库中以扩充图库的操作。
